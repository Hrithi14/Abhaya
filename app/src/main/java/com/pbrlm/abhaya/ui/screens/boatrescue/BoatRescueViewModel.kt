...
data class BoatRescueFormState(
    ...
    val medicalEmergency: Boolean = false,
...
@HiltViewModel
class BoatRescueViewModel @Inject constructor(
    private val locationService: LocationService,
    private val emergencyRepository: EmergencyRepository,
    private val userProvider: UserProvider
) : ViewModel() {

    private val _form = MutableStateFlow(BoatRescueFormState())
    val form: StateFlow<BoatRescueFormState> = _form.asStateFlow()
    ...
    fun updateBuilding(s: String)         { _form.update { it.copy(buildingFloor = s) } }
    ...
    fun updateMedical(v: Boolean)         { _form.update { it.copy(medicalEmergency = v) } }
    ...
    fun submit() {
        ...
        viewModelScope.launch {
            ...
            val priority = PriorityCalculator.calculateForBoatRescue(
                waterDepth        = f.waterDepth,
                waterRising       = f.waterRising,
                peopleTrapped     = f.peopleTrapped,
                hasmedicalEmergency = f.medicalEmergency,
            ...
            val request = EmergencyRequest(
                ...
                elderly            = f.elderly,
                disabled           = f.disabled,
                medicalRequired    = f.medicalEmergency,
